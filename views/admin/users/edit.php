            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                ...
                <div>
                    ...
                    <p class="mb-0 text-white-50">
                        Update user information, permissions and account details.
                    </p>
                        ...
                        <?php else: ?>
                            ...
                            <div class="mb-4">
                                ...
                                <p class="text-muted mb-0">
                                    Modify account details and user role.
                                </p>

                            </div>

                            <form
                                action="/projectHub/controllers/userController.php?action=update&id=<?php echo $user['id']; ?>"
                                method="POST">
